...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 4:
        print('Usage: python3 scanner.py <IP address> <start port> <end port>')
        print('Example: python3 scanner.py 192.168.1.10 1 65535\n')
        print('Usage: python3 scanner.py <network> <start port> <end port> -n')
        print('Example: python3 scanner.py 192.168.1 1 65535 -n')
